    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="https://www.vanasthali9.com/privacy"
        />
        <meta
          name="twitter:title"
          content="Privacy Policy | Vanasthali Hills | Sri Srinivasa Realty"
      ...
      <div className="flex flex-col min-h-screen ">
        ...
        <main className="flex-grow py-24">
          <section id="terms" className="container mx-auto p-6 ">
            ...
            <p className="mb-6">
              We Sri Srinivasa Realty operates this website and values your
              privacy. This Privacy Policy explains how we collect, use, and
              protect your personal information in compliance with Google Ads
              policies.
            </p>
            ...
            <p>
              When you interact with our website, campaigns, or ads, we may
              collect:
            </p>
            <ul className="list-disc ml-6">
              <li>
                Personal details (name, email, phone number) provided through
                forms.{" "}
              </li>
              <li>Property/project preferences.</li>
              <li>
                Website usage data via cookies, Google Ads tags, or analytics
                tools (IP address, device type, browsing behavior).
              </li>
            </ul>
            <h2 className="text-xl font-semibold mt-6 mb-2">
            ...
            <ul className="list-disc ml-6">
              ...
              <li>
                Share property/project updates, offers, and relevant real estate
                information.
              </li>
              <li>Improve our ads, website, and customer experience.</li>
              <li>
                Show you relevant ads across Google and partner websites
                (remarketing).
              </li>
            </ul>

            <h2 className="text-xl font-semibold mt-6 mb-2">
              3. Google Ads & Third-Party Cookies
            </h2>
            <ul className="list-disc ml-6">
              <li>We use Google Ads remarketing and conversion tracking.</li>
              <li>
                Google and third-party vendors use cookies to serve ads based on
                your past interactions with our website.
              </li>
              <li>
                You can opt out of personalized ads by visiting Google Ads
            ...
            <ul className="list-disc ml-6">
              <li>
                Trusted service providers (marketing agencies, IT support).{" "}
              </li>
            ...
            <ul className="list-disc ml-6">
              <li>Legal or regulatory authorities when required. </li>
              <li>
                You may opt out of Google’s use of cookies via the Network
                Advertising Initiative opt-out page:
                http://www.networkadvertising.org/choices/
              </li>
              <li>
                You can request access, update, or deletion of your personal
                information by contacting us at{" "}
                <b>srisrinivasarealty16@gmail.com</b>{" "}
              </li>
            </ul>
            ...
            <ul className="list-disc ml-8 mt-2">
              <li>
                <b>Sri Srinivasa Realty</b>
              </li>
              <li>
                <b>Vanasthali Hills & Estates, Hyderabad, India, Telangana</b>
              </li>
              <li>
                <b>srisrinivasarealty16@gmail.com</b>
              </li>
