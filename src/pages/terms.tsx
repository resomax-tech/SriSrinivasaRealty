    ...
    <div className="flex flex-col min-h-screen ">
      ...
      <main className="flex-grow py-24">
        ...
        <p className="mb-6">
          ...
          (<a href="https://srisrinivasarealty.com/" className="text-blue-600 underline">
            https://srisrinivasarealty.com/
          </a>), you agree to comply with and be bound by these Terms & Conditions.
        ...
        <ul className="list-disc ml-6">
          ...
          <li>You shall not attempt to misuse, hack, or disrupt our services.</li>
          <li>Information on this website is for general guidance...</li>
        </ul>

        <h2 className="text-xl font-semibold mt-6 mb-2">3. Property Information</h2>
        <p>All property listings, images, and details provided are for informational purposes only. Actual specifications, prices, and availability may differ. We do not guarantee accuracy or completeness of property information.</p>

        <h2 className="text-xl font-semibold mt-6 mb-2">4. Intellectual Property</h2>
        <p>All content on this website, including logos, images, text, and designs, are the property of Sri Srinivasa Realty. Unauthorized use, reproduction, or distribution is prohibited.</p>

        <h2 className="text-xl font-semibold mt-6 mb-2">5.Limitation of Liability</h2>
        <p>We shall not be liable for any loss, damage, or inconvenience caused due to reliance on information available on this website. Users are advised to verify property details independently.</p>
