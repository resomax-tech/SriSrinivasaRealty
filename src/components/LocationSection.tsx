  ...
  const locationFeatures = [
    {
      ...
      description: 'Connected to metro stations, major roads & ORR for easy commute.',
      color: 'bg-blue-100 text-blue-700'
    },
    {
      icon: GraduationCap,
      title: 'Educational Hub',
      description: 'Popular schools and colleges nearby (e.g., Shreyas Engineering College, Indu International School).',
