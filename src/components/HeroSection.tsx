...
const HeroSection = () => {
  return (
    ...
    >
      ...
      {/* Content on Top */}
      <div className="relative z-20 text-center mt-20 sm:mt-32 md:mt-32 max-w-7xl px-4 sm:px-6">
        <h1 className="text-2xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 leading-snug sm:leading-tight text-green-200">
          ...
          <span className="block text-2xl sm:text-4xl lg:text-6xl mt-2 sm:mt-4 text-white">
            Vanasthali Hills & Estates
          </span>
          <span className="block text-3xl sm:text-5xl lg:text-7xl mt-2 sm:mt-4 text-green-200">
            Nagole, Hyderabad
          </span>
        </h1>
